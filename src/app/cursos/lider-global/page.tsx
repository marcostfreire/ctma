        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Pastores e Líderes</h3>
              <p className="text-gray-600 text-sm">
                Pastores e líderes eclesiásticos que desejam ampliar seu impacto além das quatro paredes da igreja.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Missionários</h3>
              <p className="text-gray-600 text-sm">
                Missionários que atuam ou desejam atuar em contextos multiculturais e internacionais.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Empresários</h3>
              <p className="text-gray-600 text-sm">
                Empresários com propósito que desejam integrar valores cristãos em seus negócios.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Gestores de ONGs</h3>
              <p className="text-gray-600 text-sm">
                Diretores e gestores de organizações sociais que buscam maximizar seu impacto.
              </p>
            </div>
          </div>
        </div>
