...
export default function MonitorInternacionalPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="inscricao" className="py-16 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Torne-se um Monitor Internacional CTMA
            </h2>
            <p className="text-xl">
              Multiplique a missão da CTMA em sua região e construa uma fonte sustentável de renda ministerial.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white text-gray-900 p-8 rounded-lg shadow-xl">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <label htmlFor="cidade" className="block text-sm font-bold text-gray-700 mb-2">
                  Cidade/Região *
                </label>
                <input
                  type="text"
            ...
            <div className="mb-6">
              <label htmlFor="experiencia" className="block text-sm font-bold text-gray-700 mb-2">
                Experiência em Liderança/Ensino *
              </label>
              <select
                id="experiencia"
                name="experiencia"
              ...
              >
                ...
                <option value="pastor">Pastor/Líder de Igreja</option>
                <option value="ministerial">Líder de Ministério</option>
                <option value="educador">Educador/Professor</option>
                <option value="empresarial">Liderança Empresarial</option>
                <option value="social">Líder Social/Comunitário</option>
                <option value="outras">Outras</option>
              </select>
            </div>

            <div className="mb-6">
              <label htmlFor="interesse" className="block text-sm font-bold text-gray-700 mb-2">
                Principal Interesse *
              </label>
              <select
                id="interesse"
              ...
              >
                ...
                <option value="capelania">Formar Capelães em minha região</option>
                <option value="diplomacia">Formar Diplomatas Civis em minha região</option>
                <option value="ambos">Ambos os cursos</option>
                <option value="expansao">Expandir a missão CTMA</option>
              </select>
            </div>

            <div className="mb-6">
              <label htmlFor="mensagem" className="block text-sm font-bold text-gray-700 mb-2">
                Conte-nos mais sobre sua visão e como deseja multiplicar a missão CTMA
              </label>
              <textarea
                id="mensagem"
                name="mensagem"
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Compartilhe sua visão para multiplicar o impacto da CTMA em sua região..."
              />
            </div>
